...
public class MyApplication extends Application {
    ...
    public void onCreate() {
        ...
        UMConfigure.init(this, "5aeb17bca40fa3160500018e"
                , "umeng", UMConfigure.DEVICE_TYPE_PHONE, "");//58edcfeb310c93091c000be2 5965ee00734be40b580001a0
        PlatformConfig.setSinaWeibo("126663232", "d39969613faa5fcc75859cf8406649eb","http://sns.whalecloud.com");
        PlatformConfig.setQQZone("101133836","308674173302aa723ce7ba7a9b6807d9");
//        PlatformConfig.setWeixin("wxba2a7750630b2fa8",);
